...
if ping -q -c 1 -W 1 "$ping_host" >/dev/null; then
	...
	git clone https://github.com/Khushal-ag/hyprland_rice ~/hyprland_temp
	cp -r ~/hyprland_temp/.config ~ &&
		sudo rm -rf ~/scripts &&
		cd ~ && git clone https://github.com/Khushal-ag/scripts &&
